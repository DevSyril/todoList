...
<body class="bg-gray-200 p-4">
    <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
        ...
        <div class="mb-6">
            <form class="flex flex-col space-y-4 w-100" method="POST" action="/">
                @csrf

                <input type="text" name="title" placeholder="The todo title"
                    class="py-3 px-4 mb-4 bg-gray-100 rounded-xl w-full">

                <textarea name="description" placeholder="The to do description" class="py-3 px-4 bg-gray-100 rounded-xl w-full"></textarea>

                <Button class="w-28 py-4 px-8 mt-3 bg-green-500 text-white rounded-xl">Add</Button>
            </form>
        </div>
